...
from orders import *
from orders_font import *
from graficarAnim import Graficar
from rendimiento import mostrar_perfil
from GraficarOrdenamietos import GraficarOrds,GraficarOrds_time
from grafConteo import grafLlamadas
from graficarAnim_pab import graficarPalabra
...
# Cargar las imágenes
imagen_conejo = pygame.image.load('Fondo_Conejo.png')
imagen_fondo = pygame.image.load('fondo_nieve.png')
imagen_icono = pygame.image.load('conejito.png')
...
# Cargar el sonido
sonido_click = pygame.mixer.Sound('salto.wav')
...
################################################################################################################
#Funciones para lista con oracion
